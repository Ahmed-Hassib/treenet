  ...
  <div class="dashboard-stats">
    <div class="dashboard-content">
      <?php if ($_SESSION['sys']['user_show'] == 1) { ?>
        <div class="dashboard-card card card-white bg-gradient">
          ...
          <div class="card-body">
            ...
            $new_emp_counter = $db_obj->count_records("`UserID`", "`users`", "WHERE `deleted_at` NOT NULL AND `joined_at` = '" . get_date_now() . "' AND `company_id` = " . base64_decode($_SESSION['sys']['company_id']));
            // check counter
      ...
      <?php if ($_SESSION['sys']['dir_show'] == 1) { ?>
        <div class="dashboard-card card card-white bg-gradient">
          <img class="card-img <?php echo $page_dir == 'ltr' ? 'card-img-right' : 'card-img-left' ?>" src="<?php echo $treenet_assets . "cloud.svg" ?>" alt="">
          <div class="card-body">
            <h5 class="h5 text-capitalize">
        ...
        <?php if ($_SESSION['sys']['isLicenseExpired'] == 0) { ?>
          <div class="dashboard-card card card-white bg-gradient">
            <img class="card-img <?php echo $page_dir == 'ltr' ? 'card-img-right' : 'card-img-left' ?>" src="<?php echo $treenet_assets . "map.svg" ?>" alt="">
            <div class="card-body">
              <h5 class="h5 text-capitalize">
      ...
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false">
        ...
        <div class="carousel-inner">
          ...
          <!-- <div class="carousel-item">
            <img src="<?php echo $treenet_assets . "adv_img.svg" ?>" class="d-block w-100 card-img-top" alt="...">
            <div class="carousel-caption <?php echo $page_dir == 'rtl' ? 'text-end' : 'text-start' ?>">
