  ...
  <div class="mb-3 row g-3">
    <div class="col-sm-12 col-lg-4">
      <div class="section-block">
        ...
        <form action="" method="get" name="combination-year-form">
          <input type="hidden" name="do" value="combinations">
...
<?php if ($_SESSION['sys']['comb_delete'] == 1 && isset($deleted_combs) && $deleted_combs != null) { ?>
  ...
  <script>
    ...
    function confirm_delete_combination(btn, will_back = null) {
      // get combination info
      let combination_id = btn.dataset.combinationId;
      // prepare url
      let url = `../combinations/index.php?do=delete&combid=${combination_id}&back=true`;
