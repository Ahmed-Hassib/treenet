<!-- Modal -->
<div class="modal fade" id="deleteCombModal" tabindex="-1" aria-labelledby="deleteCombModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-capitalize " id="exampleModalLabel">
          <?php echo lang('confirm delete', 'combinations') ?>
        </h5>
      </div>
      <div class="modal-body">
        <h5 class="h5">
          <?php echo lang('CONFIRM DELETE', 'combinations') ?>&nbsp;<?php echo @$_SESSION['sys']['lang'] == "ar" ? "؟" : "?" ?>
        </h5>
      ...
      <div class="modal-footer">
        <?php if ($_SESSION['sys']['user_delete'] == 1 && $_SESSION['sys']['isLicenseExpired'] == 0) { ?>
          <a id="deleted-combination-url" dir="<?php echo @$_SESSION['sys']['lang'] == 'ar' ? 'ltr' : 'rtl' ?>" class="btn btn-danger text-capitalize fs-12 py-1">
