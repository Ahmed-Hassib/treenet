<div class="permissions">
  ...
  <div class="permission">
    ...
    <div class="permission_content">
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" value="1" name="connectionAdd" id="connectionPage1">
        <label class="form-check-label" for="connectionPage1">
          <?php echo lang("ADD") ?>
        </label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" value="1" name="connectionUpdate" id="connectionPage2">
        <label class="form-check-label" for="connectionPage2">
          <?php echo lang("EDIT") ?>
        </label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" value="1" name="connectionDelete" id="connectionPage3">
        <label class="form-check-label" for="connectionPage3">
          <?php echo lang("DELETE") ?>
        </label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" value="1" name="connectionShow" id="connectionPage4">
  ...
  <div class="permission">
    ...
    <div class="permission_content">
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" value="1" name="changeMikrotikInfo" id="changeMikrotikInfo">
  ...
  <div class="permission">
    ...
    <div class="permission_content">
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" value="1" name="changeCompanyImg" id="changeCompanyImg">
  ...
  <div class="permission">
    ...
    <div class="permission_content">
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" value="1" name="permissionUpdate" id="permissionUpdate">
        <label class="form-check-label" for="permissionUpdate">
          <?php echo lang("EDIT") ?>
        </label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" value="1" name="permissionShow" id="permissionShow">
