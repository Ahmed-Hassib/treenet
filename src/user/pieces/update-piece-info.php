...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $pcs_obj = new Pieces();
    ...
    $id = isset($_POST['piece-id']) && !empty($_POST['piece-id']) ? base64_decode(trim($_POST['piece-id'], ' ')) : 0;
    ...
    $device_id = isset($_POST['device-id']) && filter_var(intval(base64_decode(trim($_POST['device-id'], ' '))), FILTER_VALIDATE_INT) !== false ? base64_decode(trim($_POST['device-id'], ' ')) : -1;
