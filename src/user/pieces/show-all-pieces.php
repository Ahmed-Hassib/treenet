...
$pcs_obj = new Pieces();
// pieces condition
$pieces_condition = "WHERE `company_id` = " . base64_decode($_SESSION['sys']['company_id']) . " AND `is_client` = 0 AND `deleted_at` IS NULL";
// get all pieces
$all_data = $pcs_obj->get_pieces($pieces_condition);
// check counter
if (!is_null($all_data)) {
          ...
          <?php foreach ($all_data as $index => $piece) { ?>
            <tr>
              ...
              <td>
                ...
                <?php } elseif (filter_var($piece['ip'], FILTER_VALIDATE_IP) !== false) { ?>
                  <span class="text-danger fs-12 fw-bold">
              ...
              <td>
                ...
                } elseif (filter_var($piece['mac_add'], FILTER_VALIDATE_MAC) !== false) {
